...
public class specificEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getIntExtra("activity", -1)==2){
            row = whole.row;
        }
        String category = "";
        if (row == 0)
        ...
        if (fromwhole ==1 && whole.search==1){
                ...
                query.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                            ...
                            Picasso.with(getApplication()).load(url).fit().into(imageView1);
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(specificEvent.this,databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            bookmark.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {FirebaseAuth fb = FirebaseAuth.getInstance();
                ...
                public void onClick(View v) {
                    ...
                    if(fb.getCurrentUser()!=null) {
                        if(fb.getCurrentUser().isEmailVerified()) {
                            Intent i = new Intent(getApplicationContext(), mpesaPayement.class);
